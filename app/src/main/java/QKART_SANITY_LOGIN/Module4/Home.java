...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            // By.className("MuiCardContent-root css-1qw96cp"), product),
    ...
    public List<WebElement> getSearchResults() {
        ...
        try {
            ...
            // search results
            // searchResults = driver.findElementsByClassName("MuiCardContent-root css-1qw96cp");
    ...
    public Boolean addProductToCart(String productName) {
        try {
             ...
             */
            List<WebElement> gridContent = driver.findElements(By.xpath(
